<template>
  <div v-if="availableParts" class="content">
     <div class="preview">
      <!-- This shows  when no content is there in slot -->
      <!-- <CollapsibleSection>
      Foo
      </CollapsibleSection> -->
      <CollapsibleSection>
        ...
        methods: {
          ...
          addToCart() {
            ...
            const cost = robot.head.cost +
              ...
              robot.rightArm.cost +
              robot.base.cost;
            this.addRobotToCart(Object.assign({}, robot, { cost }))     //this.$store.dispatch('robots/addRobotToCart', Object.assign({}, robot, { cost }))
